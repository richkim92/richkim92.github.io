...
<swiper-container style="width: 100%; height: auto; margin-bottom: 20px;" autoplay-delay="6000" keyboard="true" navigation="true" pagination="true" pagination-clickable="true" pagination-dynamic-bullets="true" rewind="true" loop="true" autoplay-disable-on-interaction="false">
  <swiper-slide>{% include figure.liquid loading="eager" path="assets/img/main_research/main_7_3.png" class="img-fluid rounded z-depth-1" %}</swiper-slide>
  ...
  <swiper-slide>{% include figure.liquid loading="eager" path="assets/img/main_research/main_3.png" class="img-fluid rounded z-depth-1" %}</swiper-slide>
  <swiper-slide>{% include figure.liquid loading="eager" path="assets/img/main_research/main_2.png" class="img-fluid rounded z-depth-1" %}</swiper-slide>
